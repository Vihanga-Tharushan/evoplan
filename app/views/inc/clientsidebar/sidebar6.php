  ...
  <aside class="component" id="component">
      <nav class="menu">
        ...
        <nav class="frame-default">
          ...
          <a href="<?php echo URLROOT; ?>/Clients/home" class="frame-2" role="menuitem">
            
            <img class="img" src="<?php echo URLROOT; ?>/public/img/sidebar/User.svg" alt="" role="presentation" />
            <span class="text-wrapper-2">Home</span>
            </div>
          </a>
          
          <a href="<?php echo URLROOT; ?>/Clients/myevents" class="frame-2" role="menuitem" title="Events">
            <img class="img" src="<?php echo URLROOT; ?>/public/img/sidebar/event.svg" alt="" role="presentation" />
            <span class="text-wrapper-2">My Events</span>
          </a>

          <a href="<?php echo URLROOT; ?>/Clients/packages" class="frame-2" role="menuitem">
            <img class="img" src="<?php echo URLROOT; ?>/public/img/sidebar/package.svg" alt="" role="presentation" />
            <span class="text-wrapper-2">Packages</span>

          </a>

          <a href="<?php echo URLROOT; ?>/Clients/profiles" class="frame-2" role="menuitem" aria-current="page" title="Dashboard">
            
              <img class="img" src="<?php echo URLROOT; ?>/public/img/sidebar/SquaresFour.svg" alt="" role="presentation" />
              <span class="text-wrapper-2">Profiles</span>
            
          </a>

          <a href="<?php echo URLROOT; ?>/Clients/chats" class="frame-2" role="menuitem">
          ...
          <a href="<?php echo URLROOT; ?>/Clients/complains" class="frame" role="menuitem">
          <div class="div">
