...
<div class="taskbar">
  ...
  <a class="evo-plan-logo" href="<?= URLROOT; ?>/" aria-label="EvoPlan home">
    <img src="<?= URLROOT; ?>/public/img/taskbar/EvoPlan_Logo_new-removebg-preview 2.svg" alt="EvoPlan Logo" class="evo-plan-image">
  </a>

  <!-- Chat -->
  <a class="chat-icon" href="<?= URLROOT; ?>/Service/chat" aria-label="Messages">
    <div class="chat-circle">
      <img src="<?= URLROOT; ?>/public/img/taskbar/ChatsCircle.svg" alt="" class="chat-image" aria-hidden="true">
    </div>
  </a>

  <!-- Notifications -->
  <a class="notification-icon" href="<?= URLROOT; ?>/Service/notifications" aria-label="Notifications">
  ...
  <a class="profile-picture" href="<?= URLROOT; ?>/Service/accountSettings" aria-label="Profile">
    <img src="https://i.pravatar.cc/160?img=12" alt="" class="profile-image">
  </a>
</div>