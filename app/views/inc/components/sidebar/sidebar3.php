      ...
      <nav class="menu">
        ...
        <nav class="frame-default">
          ...
          <a href="<?php echo URLROOT; ?>/Service/profile" class="frame-2" role="menuitem">
            ...
            <span class="text-wrapper-2">Profile</span>
          </a>
          ...
          <a href="<?php echo URLROOT; ?>/Service/packages" class="frame" role="menuitem">
            <div class="div">
            <img class="img" src="<?php echo URLROOT; ?>/public/img/sidebar/package.svg" alt="" role="presentation" style="filter: invert(1) brightness(2);" />
          ...
          <a href="<?php echo URLROOT; ?>/Service/chat" class="frame-2" role="menuitem">
