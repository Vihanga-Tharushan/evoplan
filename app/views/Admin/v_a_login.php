<?php require_once APPROOT . '/views/inc/header.php'; ?>
  ...
  <div class="form-container-login">
      <form action="<?php echo URLROOT; ?>/Admin/admin_login" method="POST">

        <div class="form-img-container">
        <img class="form-topic" src="../public/img/choose_register/EvoPlan_Logo_new-removebg-preview 2.svg"/>
        </div>

        <div class="form-topic-login">Admin Login</div>

        
        <div class="form-input-title">Email</div>
        <input type="text" name="a_email" id="a_email" class="email" placeholder="Enter your email" value="<?php echo $data['a_email']; ?>">
        <span class="form-invalid"><?php echo $data['a_email_err']; ?></span>

        <div class="form-input-title">Password</div>
        <input type="password" name="a_password" id="a_password" class="password" placeholder="Enter your password" value="<?php echo $data['a_password']; ?>">
