  ...
  <aside class="component" id="component">
      <nav class="menu">
        ...
        <nav class="frame-default">
          ...
          <a href="<?php echo URLROOT; ?>/IssueC/dashboard" class="frame-2" role="menuitem"   title="Dashboard">  
          ...
          <a href="<?php echo URLROOT; ?>/IssueC/v_replacementslist" class="frame"  aria-current="page" role="menuitem" title="Events">
           <div class="div">
