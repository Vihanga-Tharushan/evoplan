...
<?php $finalBackUrl = URLROOT . '/IssueC/events'; ?>
...
<style>
  ...
  /* Adjust main content to account for fixed taskbar */
    ...
    <div class="sp-profilebar">
      <div class="sp-profilebar-left">
        ...
        <div class="sp-id">
          ...
          <button class="sp-message-btn" onclick="window.location.href='<?php echo URLROOT; ?>/IssueC/messageWithServiceP/<?php echo $data['profile']->service_id; ?>'">
