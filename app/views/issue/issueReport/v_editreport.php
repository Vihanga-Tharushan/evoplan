...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/components/issueC/eventsdetails.css"/>
<body>
        ...
        <form method="post" action="<?php echo URLROOT;?>/IssueC/editReport/<?php echo $data['id'] ?>" >
            <div class="issue-section">
                <div class="issue-form card">
                    ...
                    <a href="<?php echo URLROOT;?>/IssueC/deleteIssueReport/<?php echo $data['id'] ?>" class="btn-delete                    .btn-delete {
