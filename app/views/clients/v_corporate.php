...
<!-- Packages Grid -->
    <section class="packages">
        <h1 style="text-align: center; font-size: 30px; margin-top: 70px;">Corparate Events</h1>
        <h1>Past Successful Events</h1>
        <div class="packages-grid">
            <!-- Package Card 1 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (10).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">Momentum Meet</h1>
            </div>

            <!-- Package Card 2 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (11).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">Vision 360</h1>
            </div>
            <!-- Package Card 3 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (9).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                        <h1 style="text-align: center; font-size: 20px;">BizFusion</h1>
            </div>
</section>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        ...
                        <div>
                            <div class="provider-name">Lumeshi dahanayake</div>
                        </div>
                    </div>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Jenna Sullivan">
                        <div>
                            <div class="provider-name">vilium james</div>
                        </div>
                    </div>
                    <button type="button" class="view-package" onclick="location.href='<?php echo URLROOT; ?>/clients/viewpackage';">View Package →</button>
                </div>
