...
<!-- Packages Grid -->
    <section class="packages">
        <h1 style="text-align: center; font-size: 30px; margin-top: 70px;">Graduation Parties</h1>
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <h1 style="text-align: center; font-size: 20px;">Grand Gala</h1>
            </div>

            <!-- Package Card 2 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (14).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">Caps off!</h1>
            </div>
            <!-- Package Card 3 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/home/OIP (1).jpeg');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                        ...
                        <h1 style="text-align: center; font-size: 20px;">Final Bow</h1>
            </div>
</section>
...
<section class="packages">
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Shane Sullivan">
                        <div>
                            <div class="provider-name">Shane Sullivan</div>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Janak shamal">
                        <div>
                            <div class="provider-name">Janaka shamal</div>
                        </div>
                    </div>
                    <button type="button" class="view-package" onclick="location.href='<?php echo URLROOT; ?>/clients/viewpackage';">View Package →</button>
                </div>
