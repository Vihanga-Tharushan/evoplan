...
<!-- Packages Grid -->
    <section class="packages">
        <h1 style="text-align: center; font-size: 30px; margin-top: 70px;">University Functions</h1>
        <h1>Past Successful Events</h1>
        <div class="packages-grid">
            <!-- Package Card 1 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (1).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">UOC Cultural Festival</h1>
            </div>
            ...
            <div class="package-card">
                ...
                <h1 style="text-align: center; font-size: 20px;">Drama night</h1>
            </div>
            <!-- Package Card 3 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/home/OIP (1).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                        ...
                        <h1 style="text-align: center; font-size: 20px;">Career Fair</h1>
            </div>
</section>
...
<section class="packages">
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        ...
                        <div>
                            <div class="provider-name">Amal Perera</div>
                        </div>
                    </div>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Kamal Jayawardana">
                        <div>
                            <div class="provider-name">Kamal Jayawardana</div>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Ayeshika Athapaththu">
                        <div>
                            <div class="provider-name">Ayeshika Athapaththu</div>
                        </div>
                    </div>
                    <button type="button" class="view-package" onclick="location.href='<?php echo URLROOT; ?>/clients/viewpackage';">View Package →</button>
                </div>
