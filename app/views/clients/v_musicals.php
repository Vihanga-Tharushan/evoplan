...
<!-- Packages Grid -->
    <section class="packages">
        <h1 style="text-align: center; font-size: 30px; margin-top: 70px;">Musicals</h1>
        <h1>Past Successful Events</h1>
        <div class="packages-grid">
            <!-- Package Card 1 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (4).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">Vibes of Moratuwa</h1>
            </div>
            ...
            <div class="package-card">
                ...
                <h1 style="text-align: center; font-size: 20px;">Rhythm of kelaniya</h1>
            </div>
            <!-- Package Card 3 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (5).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                        <h1 style="text-align: center; font-size: 20px;">Gee tharuwa</h1>
            </div>
</section>
...
<section class="packages">
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        ...
                        <div>
                            <div class="provider-name">Shanika Liyanagama</div>
                        </div>
                    </div>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Jenna Sullivan">
                        <div>
                            <div class="provider-name">Namal priyantha</div>
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Kasun Abewardana">
                        <div>
                            <div class="provider-name">Kasun Abewardana</div>
