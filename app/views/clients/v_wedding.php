...
<!-- Packages Grid -->
    <section class="packages">
        <h1 style="text-align: center; font-size: 30px; margin-top: 70px;">Weddings</h1>
        <h1>Past Successful Events</h1>
        <div class="packages-grid">
            <!-- Package Card 1 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP.jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">Pawani's Wedding</h1>
            </div>

            <!-- Package Card 2 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (2).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                <h1 style="text-align: center; font-size: 20px;">Anusha's wedding</h1>
            </div>
            <!-- Package Card 3 -->
            <div class="package-card">
                <div class="package-image" style="background-image: url('<?php echo URLROOT; ?>/img/events/OIP (2).jpeg?height=200&width=300');" onclick="location.href='<?php echo URLROOT; ?>/clients/dummy';">
                </div>
                        <h1 style="text-align: center; font-size: 20px;">jame's wedding</h1>
            </div>
</section>
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <div class="package-footer">
                    <div class="provider">
                        <img src="<?php echo URLROOT; ?>/img/home/profile.svg?height=32&width=32" alt="Suijith liyanage">
                        <div>
                            <div class="provider-name">Suijith liyanage</div>
